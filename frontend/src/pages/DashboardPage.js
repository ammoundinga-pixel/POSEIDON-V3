          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-4">
              <Card data-testid="service-distribution-chart">
                ...
                <CardContent>
                  {(() => {
                    const pieData = Object.entries(dashboard.service_hours || {}).map(([key, value]) => ({
                      name: key,
              ...
              <>
                <div className="col-span-12 lg:col-span-3">
                  <Card data-testid="total-hours-card">
                    ...
                    <CardContent>
                      <div className="text-4xl font-heading font-bold">{safeToFixed(dashboard.total_hours)}h</div>
                    </CardContent>
                  </Card>
                </div>
            ...
            {dashboard.service_hours && (
              <div className="col-span-12 lg:col-span-4">
                <Card data-testid="global-service-distribution-chart">
                  ...
                  <CardContent>
                    {(() => {
                      const pieData = Object.entries(dashboard.service_hours || {})
                        .map(([key, value]) => ({
                          name: key,
                          value: Number(value) || 0
                        }))
